package com.willian.usuario.controller;
...
import com.willian.usuario.interfacesService.I_usuarioService;
import com.willian.usuario.models.usuario;
import com.willian.usuario.service.emailService;
...
public class usuarioController {
    ...
    public ResponseEntity<Object> save(@RequestBody usuario usuario) {
        usuario.setFecha_ultima_actulizacion_contrasena(new Date()); // Asigna la fecha de actualización actual
	...
	public ResponseEntity<Object> update(@PathVariable("id") String id, @RequestBody usuario usuarioUpdate){
		...
		if (usuario != null) {
            ...
            usuario.setFecha_ultima_actualizacion_contrasena(usuarioUpdate.getFecha_ultima_act_contrasena());
            usuario.setFecha_del_ultimo_inicio_sesion(usuarioUpdate.getFecha_ultimo_inicio_sesion());
